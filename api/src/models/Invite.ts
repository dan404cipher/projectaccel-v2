...
inviteSchema.statics.revokePendingInvites = async function(email: string, workspaceId: mongoose.Types.ObjectId) {
...
inviteSchema.statics.getWorkspaceStats = async function(workspaceId: mongoose.Types.ObjectId) {
